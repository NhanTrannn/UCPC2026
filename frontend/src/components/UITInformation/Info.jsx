  ...
  return (
    <section id="Info" className="relative w-full min-h-screen py-28 md:py-28 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-[minmax(0,1.15fr)_minmax(0,0.85fr)] gap-8 md:gap-10 items-center px-4 md:px-8 2xl:gap-16">
        ...
        {/* Right: Google Maps */}
        <div className="relative rounded-2xl shadow-xl border border-blue-500 glow-animation w-full">
          <iframe
            title="UIT Map"
            ...
            allowFullScreen
            loading="lazy"
            className="rounded-2xl h-64 md:h-[500px] 2xl:h-[600px]"
          />
        </div>

        {/* Left: Tabs */}
        <div className="h-full relative z-10 max-w-2xl">
